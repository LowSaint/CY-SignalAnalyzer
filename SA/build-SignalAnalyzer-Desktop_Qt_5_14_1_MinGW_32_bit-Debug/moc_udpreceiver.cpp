...
QT_MOC_LITERAL(1, 12, 14), // "packetReceived"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "count"
QT_MOC_LITERAL(4, 34, 15), // "packetDataBatch"
QT_MOC_LITERAL(5, 50, 8), // "dataList"
QT_MOC_LITERAL(6, 59, 11), // "onReadyRead"
QT_MOC_LITERAL(7, 71, 18) // "processPacketBatch"

    },
    "UdpReceiver\0packetReceived\0\0count\0"
    "packetDataBatch\0dataList\0onReadyRead\0"
    "processPacketBatch"
};
...
void UdpReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->processPacketBatch(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UdpReceiver::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpReceiver::packetReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UdpReceiver::*)(const QList<QByteArray> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpReceiver::packetDataBatch)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void UdpReceiver::packetReceived(int _t1)
{
...
// SIGNAL 1
void UdpReceiver::packetDataBatch(const QList<QByteArray> & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
